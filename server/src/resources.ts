...
export const possibleOptions = [
    ...
    "percentile", "percentilemarkers", "percentiles", "period", "periods", "pinradius", "placeholders",
    "pointerposition", "portal", "position", "primarykey", "properties", "range", "rangemerge", "rangeoffset",
    "rangeselectend", "rangeselectstart", "rate", "ratecounter", "ratio", "refresh", "refreshinterval", "reload",
    "render", "replace", "replaceunderscore", "replacevalue", "responsive", "retaintimespan", "retryrefreshinterval",
    "rightaxis", "ringwidth", "rotatelegendticks", "rotatepaletteticks", "rotateticks", "rowalertstyle", "rowstyle",
    "rule", "scale", "scalex", "scaley", "script", "selectormode", "series", "serieslabels", "serieslimit",
    "seriestype", "seriesvalue", "server", "serveraggregate", "severity", "severitystyle", "showtagnames", "size",
    "sizename", "sort", "source", "stack", "start", "starttime", "startworkingminutes", "statistic", "statistics",
    "stepline", "style", "summarize", "summarizeperiod", "summarizestatistic", "svg", "table", "tableheaderstyle",
    "tag", "tagexpression", "tagoffset", "tags", "tagsdropdowns", "tagsdropdownsstyle", "tension", "threshold",
    "thresholds", "ticks", "ticksright", "tickstime", "timeoffset", "timespan", "timezone", "title", "tooltip",
    "topaxis", "topunits", "totalsize", "totalvalue", "transpose", "type", "unscale", "update", "updateinterval",
    "updatetimespan", "url", "urllegendticks", "urlparameters", "value", "verticalgrid", "widgets", "widgetsperrow",
    "width", "widthunits", "zoomsvg",
];
